...
public class OldGameManager : MonoBehaviour
{
    ...
    public IEnumerator SetupGame(bool isSandbox, float delay = 0.1f)
    {
        ...
        var bottlePosition = currentLevel.shouldBeRandomBallPosition ? Random.Range(0, 9) : currentLevel.bottlePosition;
        ...
        if (gameData.roundNumber == 0)
        {
            bottle.spillLiquid.LiquidLevel = 1;
        }
    ...
    {
        // calculate score
        float score = bottle.spillLiquid.LiquidLevel * 90;
